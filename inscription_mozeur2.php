...
//         $sql = "INSERT INTO  entreprise (nom, prenom,telephone, adresse1 ,adresse2 , adresse3) VALUE (:forme_juridique,:nom_entreprise,:civilite_dirigeant,:nom_dirigeant,:status_dirigeant,:n_siret, :code_ape,:n_tva)";
        ...
        <section>
            <article>
                <form action="" method="post">
                    ...
                    <div>
        <button class="valider" type="submit" ><a href="inscription_mozer3.php">Suivant</a></button>
